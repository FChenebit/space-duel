...
export interface ITKSpriteManager {
  ...
  newText(newText:string, newX:number, newY:number, newStyle:Phaser.Types.GameObjects.Text.TextStyle):string
  ...
  changeRepresentationText(representationId: string, newText: string): void;
