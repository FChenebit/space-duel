...
describe('SIAEnemyShip', () => {
  ...
  newEnemyShip.execute(0,200,0,Math.PI/16,SEnemyShipTypeEnum.HUNTER);
  ...
  describe('same scenario, but max steering = PI/32',() => {
    describe('Scenario 2-0 : Enemy ship x0, y -100, rotation 0', () => {
      const enemyShip = repository.getById('ID-5')!;
      enemyShip.steering = Math.PI/32;
      it('01 - should find a Math.PI/16 rotation', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64, 0, -100, 0); // 64 car 500ms
      });
      it('02 -should find a Math.PI/16+Math.PI/4 rotation', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/4, 0, -100, Math.PI/4);
      });
      it('03 - should find a Math.PI/16+Math.PI/2 rotation', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/2, 0, -100, Math.PI/2);
      });
      it('04 - should find a Math.PI/16+Math.PI*3/4 rotation', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI*3/4, 0, -100, Math.PI*3/4);
      });
      it('05 - should find a Math.PI rotation', () => {
        testEnemyShipRotation(enemyShip, Math.PI, 0, -100, Math.PI);
      });
    ...
    describe('Scenario 2-1 : Enemy ship x-100, y -100', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      it('11 R 0', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64, -100, -100, 0);
      });
      it('12 R Math.PI/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/4, -100, -100, Math.PI/4);
      });
      it('13 R Math.PI/2', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/2, -100, -100, Math.PI/2);
      });
      it('14 R Math.PI*3/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI*3/4, -100, -100, Math.PI*3/4);
      });
      it('15 R Math.PI', () => {
        testEnemyShipRotation(enemyShip, Math.PI-Math.PI/64, -100, -100, Math.PI);
      });
      it('16 R Math.PI/-4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/-4, -100, -100, Math.PI/-4);
      });
      ...
      it('18 R Math.PI*-3/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/-64+Math.PI*-3/4, -100, -100, Math.PI*-3/4);
      });
      it('19 R Math.PI/-1', () => {
        testEnemyShipRotation(enemyShip, Math.PI-Math.PI/64, -100, -100, Math.PI/-1);
      });
    });

    describe('Scenario 2-2 : Enemy ship x-100, y -0', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      it('21 R 0', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64, -100, 0, 0);
      });
      it('22 R Math.PI/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/4, -100, 0, Math.PI/4);
      });
      it('23 R Math.PI/2', () => {
        testEnemyShipRotation(enemyShip, Math.PI/2, -100, 0, Math.PI/2);
      });
      it('24 R Math.PI*3/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/-64+Math.PI*3/4, -100, 0, Math.PI*3/4);
      });
      it('25 R Math.PI', () => {
        testEnemyShipRotation(enemyShip, Math.PI-Math.PI/64, -100, 0, Math.PI);
      });
      it('26 R Math.PI/-4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/-4, -100, 0, Math.PI/-4);
      });
      it('27 R Math.PI/-2', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/-2, -100, 0, Math.PI/-2);
      });
      it('28 R Math.PI*-3/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/-64+Math.PI*-3/4, -100, 0, Math.PI*-3/4);
      });
      it('29 R Math.PI/-1', () => {
        testEnemyShipRotation(enemyShip, Math.PI-Math.PI/64, -100, 0, Math.PI/-1);
      });
    });

    describe('Scenario 2-3 : Enemy ship x-100, y 100, rotation 0', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      it('31 R 0', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64, -100, 100, 0);
    ...
    describe('Scenario 2-4 : Enemy ship x 0, y 100', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      it('41 R 0', () => {
        testEnemyShipRotation(enemyShip, 0, 0, 100, 0);
      ...
      it('45 R Math.PI', () => {
        testEnemyShipRotation(enemyShip, -1*(Math.PI-Math.PI/64), 0, 100, Math.PI);
      });
      it('46 R Math.PI/-4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/64+Math.PI/-4, 0, 100, Math.PI/-4);
      });
      ...
      it('49 R Math.PI/-1', () => {
        testEnemyShipRotation(enemyShip, (Math.PI*-1)+Math.PI/64, 0, 100, Math.PI/-1);
      });
    });

    describe('Scenario 2-5 : Enemy ship x 100, y 100', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      ...
      it('55 R Math.PI', () => {
        testEnemyShipRotation(enemyShip, (Math.PI*-1)+Math.PI/64, 100, 100, Math.PI);
      });
      it('56 R Math.PI/-4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/-4, 100, 100, Math.PI/-4);
      });
      ...
      it('59 R Math.PI/-1', () => {
        testEnemyShipRotation(enemyShip, (Math.PI*-1)+Math.PI/64, 100, 100, Math.PI/-1);
      });
    });

    describe('Scenario 2-6 : Enemy ship x 100, y 0', () => {
      const enemyShip = repository.getById('ID-5')!;    
      enemyShip.steering = Math.PI/32;
      ...
      it('65 R Math.PI', () => {
        testEnemyShipRotation(enemyShip, (Math.PI*-1)+Math.PI/64, 100, 0, Math.PI);
      });
      it('66 R Math.PI/-4', () => {
        testEnemyShipRotation(enemyShip, Math.PI/-64+Math.PI/-4, 100, 0, Math.PI/-4);
      });
      ...
      it('69 R Math.PI/-1', () => {
        testEnemyShipRotation(enemyShip, (Math.PI*-1)+Math.PI/64, 100, 0, Math.PI/-1);
      });
    });
    ...
    describe('Scenario 7 : Enemy ship x 100, y -100, rotation 0', () => {
      ...
      it('77 R Math.PI/-2', () => {
        testEnemyShipRotation(enemyShip,Math.PI/-2-Math.PI/64, 100, -100, Math.PI/-2);
      });
      it('78 R Math.PI*-3/4', () => {
        testEnemyShipRotation(enemyShip, Math.PI*-3/4, 100, -100, Math.PI*-3/4);
      });
